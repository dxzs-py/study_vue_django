# Generated by Django 5.1.6 on 2025-04-07 14:02
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_type', models.SmallIntegerField(choices=[(0, '付费课程'), (1, 'VIP专享'), (2, '学位课程')], default=0, verbose_name='付费类型')),
                ...
                ('course_category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='course.coursecategory', verbose_name='课程分类')),
                ('teacher', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='course.teacher', verbose_name='授课老师')),
            ],
            options={
                'verbose_name': '专题课程',
