    ...
    <div class="main">
      <div class="title">
        <div class="success-tips">
          ...
          <p class="tips2">你还可以加入QQ群 <span>3309201506</span> 学习交流</p>
        </div>
      </div>
      <div class="order-info">
        <p class="info1"><b>付款时间：</b><span>{{ pay_time | timeformat }}</span></p>
        <p class="info2"><b>付款金额：</b><span>{{ real_price.toFixed(2) }}</span></p>
        <p class="info3"><b>课程信息：</b><span v-for="course in course_list">《<router-link
          :to="'/courses/detail/'+course.id">{{ course.name }}</router-link>》</span></p>
      </div>
